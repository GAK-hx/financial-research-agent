...
def _spark(output_root: Path, cpu_count: int):
    ...
    return (
        ...
        .appName("financial-agent-step03-spark-iceberg-gate")
...
def run_gate(
    ...
    *,
    ...
    if row_count < 100_000:
        raise ValueError("row_count must be at least 100,000 for this performance gate")
    ...
    try:
        ...
        report = {
            ...
            "gate": "phase5_step03_spark_iceberg",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Step 03-C Spark/Iceberg gate")
    parser.add_argument("--output-root", type=Path, required=True)
    parser.add_argument("--rows", type=int, default=5_000_000)
    parser.add_argument("--cpus", type=int, default=4)
    args = parser.parse_args()
    report = run_gate(args.output_root, row_count=args.rows, cpu_count=args.cpus)
