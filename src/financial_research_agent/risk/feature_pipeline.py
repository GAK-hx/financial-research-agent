...
from financial_research_agent.risk.models import DataAvailability, RiskCategory, RiskStatus
...
def _markdown(report: dict[str, Any]) -> str:
    lines = [
        "# Step 01 Point-in-Time 特征与规则候选报告",
        "",
...
def main() -> None:
    ...
    parser.add_argument("--root", default="/artifacts/phase5_step01/features_v1")
    parser.add_argument(
