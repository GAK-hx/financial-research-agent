...
def main() -> None:
    ...
    parser.add_argument(
        "--candidates",
        default="/artifacts/risk_data/features_v1/risk_candidates.parquet",
    )
    parser.add_argument(
        "--features",
        default="/artifacts/risk_data/features_v1/risk_features.parquet",
    )
    parser.add_argument(
        "--output-root",
        default="/artifacts/agent_benchmarks/risk_team_smoke_v1",
    )
