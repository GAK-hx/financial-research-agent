...
from financial_research_agent.risk.domain.disclosures import normalize_disclosures
from financial_research_agent.risk.domain.models import DisclosureEvent, IssuerPoolEntry
...
from financial_research_agent.risk.data.source_audit import _call_with_retry, _frame_digest
...
def main() -> None:
    ...
    parser.add_argument("--root", default="artifacts/risk_data/disclosure_pool_v1")
