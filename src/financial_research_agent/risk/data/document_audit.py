...
def run_document_audit(
    ...
    *,
    ...
    session.headers.update(
        {
            "User-Agent": "Mozilla/5.0 MorshanDocumentAudit/1.0",
...
def main() -> None:
    ...
    parser.add_argument("--root", default="/artifacts/risk_data/document_audit_v1")
    parser.add_argument(
    ...
    parser.add_argument(
        "--statement-root", default="/artifacts/risk_data/correctness_pool_v1"
    )
