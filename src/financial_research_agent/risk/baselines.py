...
def run_baselines(root: Path, *, feature_root: Path) -> tuple[Path, Path]:
    ...
    report = {
        ...
        "historical_pit_gold_gate": "pending_historical_snapshots_and_human_labels",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Step 01 rule and statistical baselines")
    parser.add_argument("--root", default="/artifacts/phase5_step01/baselines_v1")
    parser.add_argument("--feature-root", default="/artifacts/phase5_step01/features_v1")
