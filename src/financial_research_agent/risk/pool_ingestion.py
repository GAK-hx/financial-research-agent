...
from financial_research_agent.risk.models import IssuerPoolEntry
from financial_research_agent.risk.normalize import MAPPING_VERSION, normalize_eastmoney_statement
from financial_research_agent.risk.pools import load_correctness_pool
from financial_research_agent.risk.schema import DWD_FACT_SCHEMA, DWD_FACT_TABLE, TABLE_SCHEMAS
from financial_research_agent.risk.source_audit import Probe, _call_with_retry, _frame_digest
...
def main() -> None:
    ...
    parser.add_argument("--root", default="artifacts/phase5_step01/correctness_pool_v1")
